  ...
  return [
    {
      ...
      location: { lat: 25.2867, lng: 51.5333, area: "Souq Waqif · Doha", notes: "Side door near Al Bidda St, ring bell" },
    },
    {
      id: rid(),
      donorId: "seed-2",
      ...
      location: { lat: 25.3211, lng: 51.5300, area: "West Bay · Doha", notes: "Hotel staff entrance, parking lot B" },
    },
    {
      id: rid(),
      donorId: "seed-3",
      ...
      photo: "https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=800&q=70&auto=format&fit=crop",
      location: { lat: 25.2697, lng: 51.4914, area: "Al Sadd · Doha", notes: "Building 7, ground floor — call when arriving" },
    },
    {
      id: rid(),
      donorId: "seed-4",
      businessName: "Layali Catering",
      businessType: "Catering",
      foodDescription: "Wedding leftovers — machboos, kebabs, hummus, salads",
      quantity: "35 portions",
      pickupArea: "The Pearl · Doha",
      donorKind: "BUSINESS",
      ...
      hygieneNotes: "Sealed in catering trays straight after service.",
      photo: "https://images.unsplash.com/photo-1555992336-fb0d29498b13?w=800&q=70&auto=format&fit=crop",
      location: { lat: 25.3700, lng: 51.5500, area: "The Pearl · Doha", notes: "Marina Walk, near tower 14 loading bay" },
    },
    {
      id: rid(),
      donorId: "seed-5",
      businessName: "Green Basket Mart",
      businessType: "Grocery",
      foodDescription: "Fresh produce close to date — tomatoes, lettuce, apples, bananas",
      quantity: "8 boxes",
      pickupArea: "Al Wakrah",
      donorKind: "BUSINESS",
      expiresAt: now + 180 * 60 * 1000,
      createdAt: now - 20 * 60 * 1000,
      status: "AVAILABLE",
      foodCategory: "PRODUCE",
      packaging: "SEALED",
      allergens: [],
      hygieneNotes: "Stored chilled until handover.",
      photo: "https://images.unsplash.com/photo-1542838132-92c53300491e?w=800&q=70&auto=format&fit=crop",
      location: { lat: 25.1715, lng: 51.6034, area: "Al Wakrah", notes: "Back of store, ask for Ahmed" },
    },
  ];
};
